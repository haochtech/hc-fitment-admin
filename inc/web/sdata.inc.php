...
if ($_W['ispost'])
{
    ...
    if ($guide_add_class == '1')
    {
        ...
        // 复制文件
        @copy(MODULE_ROOT . '/public/images/sdata/term/01.png', ATTACHMENT_ROOT . $path . 'img_term_1.png');
        @copy(MODULE_ROOT . '/public/images/sdata/term/02.png', ATTACHMENT_ROOT . $path . 'img_term_2.png');
        @copy(MODULE_ROOT . '/public/images/sdata/term/03.png', ATTACHMENT_ROOT . $path . 'img_term_3.png');
        @copy(MODULE_ROOT . '/public/images/sdata/term/04.png', ATTACHMENT_ROOT . $path . 'img_term_4.png');
        @copy(MODULE_ROOT . '/public/images/sdata/term/05.png', ATTACHMENT_ROOT . $path . 'img_term_5.png');
        @copy(MODULE_ROOT . '/public/images/sdata/term/06.png', ATTACHMENT_ROOT . $path . 'img_term_6.png');
        @copy(MODULE_ROOT . '/public/images/sdata/term/07.png', ATTACHMENT_ROOT . $path . 'img_term_7.png');
        @copy(MODULE_ROOT . '/public/images/sdata/term/08.png', ATTACHMENT_ROOT . $path . 'img_term_8.png');
        @copy(MODULE_ROOT . '/public/images/sdata/term/09.png', ATTACHMENT_ROOT . $path . 'img_term_9.png');
        @copy(MODULE_ROOT . '/public/images/sdata/term/10.png', ATTACHMENT_ROOT . $path . 'img_term_10.png');
        @copy(MODULE_ROOT . '/public/images/sdata/term/11.png', ATTACHMENT_ROOT . $path . 'img_term_11.png');
...
include $this->template('web/sdata');
