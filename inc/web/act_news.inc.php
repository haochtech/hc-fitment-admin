...
if ($operation == 'display') {
    ...
    $term = pdo_fetchall("SELECT id,termname FROM " . tablename('slwl_fitment_act_term')
    ...
    $term = pdo_fetchall('SELECT * FROM ' . tablename('slwl_fitment_act_term') . ' WHERE 1 ' . $condition_term, $params_term);
...
include $this->template('web/act-news');
